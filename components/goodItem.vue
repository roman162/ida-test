<template>
  <div class="good-item__wrapper">
    <div class="good-item__container">
      <div class="good-item__image-container">
        <img :src="good.link" class="good-item__image">
      </div>
      <div class="good-item__content">
        <h3 class="good-item__title">
          {{ good.title }}
        </h3>
...
export default {
  ...
  methods: {
    deleteItem () {
      this.$store.commit('DELETE_GOOD', this.good.id)
    }
  }
}
</script>
